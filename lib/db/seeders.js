...
const DEFAULT_PAGE_SECTIONS = [
  ...
  },
  {
    ...
    page: "Our Story",
    section_id: "lineage",
    label: "Our Story → Chapter I: Heritage Lineage",
    content_json: JSON.stringify({
      badge: "OUR HERITAGE",
  ...
  },
  {
    ...
    page: "Our Story",
    section_id: "values",
    label: "Our Story → Chapter II: Core Values",
    content_json: JSON.stringify({
      eyebrow: "OUR VALUES",
  ...
  },
  {
    ...
    page: "Our Story",
    section_id: "stats",
    label: "Our Story → Chapter III: Heritage Stats Strip",
    content_json: JSON.stringify({
      stats: [
  ...
  },
  {
    ...
    page: "Our Story",
    section_id: "vision",
    label: "Our Story → Chapter IV: Vision for the World",
    content_json: JSON.stringify({
      eyebrow: "OUR VISION",
  ...
  },
  {
    ...
    page: "Our Story",
    section_id: "cta",
    label: "Our Story → Chapter V: Story Closing CTA",
    content_json: JSON.stringify({
