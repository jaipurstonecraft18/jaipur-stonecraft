  ...
  try {
    ...
    if (colRow) {
      ...
      return {
        ...
        imageSrc: colRow.image_src || existingStatic.imageSrc || "https://placehold.co/800x500/E8E4DF/1A1918?text=Collection+Cover",
        subcategories
      };
    }
  } catch (e) {}
  ...
  try {
    ...
    if (catRow) {
      return {
        ...
        imageSrc: catRow.image_src || "https://placehold.co/800x500/E8E4DF/1A1918?text=Category+Cover",
    ...
    for (const row of catRows) {
      if (!subcategorySlug || row.parent_subcategory_slug === subcategorySlug || !row.parent_subcategory_slug) {
        mergedMap.set(row.slug, {
          ...
          imageSrc: row.image_src || "https://placehold.co/800x500/E8E4DF/1A1918?text=Category+Cover",
