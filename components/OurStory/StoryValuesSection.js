...
export default function StoryValuesSection() {
  return (
      ...
      <Container>
        <ScrollReveal animation="fade-up">
          <div className={styles.valuesHeader}>
            ...
            <h2 className={styles.valuesHeading}>Principles Behind Every Chisel</h2>
        ...
        <div className={styles.valuesGrid}>
          {valuesList.map((val, idx) => (
            <ScrollReveal key={val.num} animation="fade-up" delay={idx * 60}>
